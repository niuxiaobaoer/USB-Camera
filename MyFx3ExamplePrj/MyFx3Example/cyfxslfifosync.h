 ...
 */
#define CY_FX_SLFIFO_GPIF_16_32BIT_CONF_SELECT (1) //only 32Bits the Usart are act!

#define CY_FX_SLFIFO_DMA_BUF_COUNT      (6)                       /* Slave FIFO channel buffer count */
...
/*///////////////////////////////////////////////////////////*/
#define CY_FX_USB_UART_SET_REQ_TYPE     (uint8_t)(0x21)        /* UVC interface SET request type */
#define CY_FX_USB_UART_GET_REQ_TYPE     (uint8_t)(0xA1)        /* UVC Interface GET request type */
#define CY_FX_USB_UART_GET_CUR_REQ      (uint8_t)(0x81)        /* UVC GET_CUR request */
#define CY_FX_USB_UART_SET_CUR_REQ      (uint8_t)(0x01)        /* UVC SET_CUR request */
#define CY_FX_UART_MAX_BUFFER_SIZE		(16)
/*///////////////////////////////////////////////////////////*/
